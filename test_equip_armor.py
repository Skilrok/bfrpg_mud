...
def test_equip_armor(character_name):
    ...
    with get_db_context() as db:
        try:
            ...
            armor_item = db.query(models.Item).filter(models.Item.item_type == "armor").first()
            ...
            if character.armor_class == expected_ac:
                ...
                print(f"ERROR: Armor class not updated correctly. Got {character.armor_class}, expected {expected_ac}")
                return False
