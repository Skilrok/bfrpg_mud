...
def downgrade():
    ...
    with op.batch_alter_table('characters') as batch_op:
        batch_op.add_column(sa.Column('equipment', sa.JSON(), server_default='{}', nullable=True))
        batch_op.add_column(sa.Column('inventory', sa.JSON(), server_default='{}', nullable=True)) 