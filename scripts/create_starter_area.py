...
async def create_starter_area():
    ...
    try:
        ...
        with get_db_context() as db:
            ...
            existing_area = (
                db.query(Area).filter(Area.name == "Starting Village").first()
            )
            if existing_area:
            ...
            items = [
                ...
                Item(
                    ...
                    item_type="ARMOR",
                    room_id=rooms["blacksmith"].id,
                    properties={"defense": 1, "value": 10, "weight": 5},
                ),
                Item(
                    name="Healing Potion",
                    ...
                    properties={"healing": "2d4+2", "value": 15, "weight": 0.5},
                ),
                Item(
                    name="Torch",
                    ...
                    item_type="MISC",
                    room_id=rooms["general_store"].id,
                    properties={"duration": 60, "value": 1, "weight": 1},  # minutes
                ),
                Item(
                    name="Mug of Ale",
