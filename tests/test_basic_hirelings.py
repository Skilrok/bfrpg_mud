...
if os.path.exists(TEST_DB_PATH):
    try:
        ...
        TEST_DB_PATH = (
            f"test_basic_hirelings_{threading.get_ident()}_{uuid.uuid4().hex[:8]}.db"
        )
...
from app.models import Character, Hireling, User
...
@pytest.mark.skip(
    reason="Basic hireling tests need to be updated to match the new model structure"
)
