...
pytestmark = pytest.mark.xfail(
    reason="Integration tests require a running server and database"
)
...
class TestAuthenticationAPI:
    ...
    def test_login_api(self, api_client):
        ...
        # Test login
        login_data = {"username": unique_username, "password": "testpassword123"}
...
class TestCharacterAPI:
    ...
    def test_character_stats_api(self, api_client, auth_token, character_id):
        ...
        response = api_client.get(
            f"{API_URL}/characters/{character_id}/stats", headers=headers
        )
...
class TestInventoryAPI:
    def test_inventory_retrieval_api(self, api_client, auth_token, character_id):
        ...
        response = api_client.get(
            f"{API_URL}/characters/{character_id}/inventory", headers=headers
        )
...
class TestGameCommandAPI:
    def test_look_command_api(self, api_client, auth_token, character_id):
        ...
        response = api_client.post(
            f"{API_URL}/game/command", json=command_data, headers=headers
        )
...
class TestUIAPIIntegration:
    ...
    def test_persistent_game_state(
        self, api_client, auth_token, character_id, game_session
    ):
