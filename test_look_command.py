...
AUTH_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsImV4cCI6MTc0NTI4NTAzNn0.oo5Eq4MCb78aQvMcfQBf_kBNsCPh_J-ehdGze3NOTIM"
CHARACTER_ID = 1  # Change to your character ID
...
async def test_look_command():
    ...
    try:
        ...
        async with websockets.connect(WS_URL) as ws:
            ...
            if not response_data.get('success', False):
                if "Invalid or expired token" in response_data.get('message', ''):
                    print("\n===== TOKEN EXPIRED =====")
                    print("Your authentication token has expired. Please generate a new token.")
        ...
        logger.error("Connection closed normally - likely due to authentication failure")
        return False
    except Exception as e:
