    ...
    try:
        with get_db_context() as db:
            ...
            if 'ac_bonus' in item_json and item_json['ac_bonus'] is not None:
                ...
                logger.info("The UI will correctly display this value using the updated JavaScript code")
            else:
            ...
            if 'properties' in item_json and item_json['properties'] and 'ac_bonus' in item_json['properties']:
                ...
                if item_json.get('ac_bonus') == properties_ac_bonus:
                    ...
                    logger.warning("⚠️ The column value does NOT match the properties value")
                    logger.info(f"   Column: {item_json.get('ac_bonus')}, Properties: {properties_ac_bonus}")
            else:
