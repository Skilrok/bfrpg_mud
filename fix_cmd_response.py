...
if __name__ == "__main__":
    ...
    print(f"WebSocket command response fix result: {'Success' if ws_result else 'Failed'}")
    
    print("Step 2: Enhancing debug command...")
    debug_result = enhance_debug_command()
    print(f"Debug command enhancement result: {'Success' if debug_result else 'Failed'}")
