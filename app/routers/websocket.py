...
class ConnectionManager:
    ...
    async def broadcast_to_room(
        self, message: dict, room_id: str, exclude_user: Optional[int] = None
    ):
...
async def websocket_endpoint(
    ...
    await manager.broadcast_to_room(
        {"type": "system", "message": f"{username} has joined the room"}, room_id
    )
    ...
    try:
        ...
        await manager.broadcast_to_room(
            {"type": "system", "message": f"{username} has left the room"}, room_id
        )
